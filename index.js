...
function addTodo(todo){
    let todoTask  = ` 
                <div class="task">
                    ...
                    <div>
                        <input type="button" value="Update" name='update' title='update task' class="update-task">
                        <input type="button" value="Rename" name='rename' title='rename task' class="rename-task">
